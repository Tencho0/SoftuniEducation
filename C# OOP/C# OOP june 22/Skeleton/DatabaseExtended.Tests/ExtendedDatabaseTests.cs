namespace DatabaseExtended.Tests
{
    ...
    public class ExtendedDatabaseTests
    {
        ...
        public void Constructor_Should_Initialize_Properly(Person[] people, int expectedCount)
        {
            ...
            Assert.That(expectedCount, Is.EqualTo(database.Count), "The count in the database does not match with input array count.");
        }
        ...
        public void Constructor_Should_Throw_Argument_Exception_When_Input_Lenght_Is_Above_Sixteen()
        {
            Person[] people = new Person[]
            {
                ...
                new Person(5, "Pesho"),
                new Person(6, "Sashp"),
                new Person(7, "Iwancho"),
                new Person(8, "Dragancho"),
                new Person(9, "Petkanchp"),
                new Person(10, "Alexander"),
                new Person(11, "Bari"),
                new Person(12, "Drundio"),
                new Person(13, "Mihail"),
                new Person(14, "Spartak"),
                new Person(15, "Kriso"),
                new Person(16, "Angel"),
                new Person(17, "Sliwen"),
            };
        ...
        public void Find_By_Id_Should_Return_Correct_Person()
        {
            ...
            Assert.That(people[7], Is.EqualTo(db.FindById(123)));
        }
